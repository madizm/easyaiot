...
그들은 EasyAIoT를 「사용 가능」에서 「쉽고 잘 사용」으로 이끄는 선구자입니다. 아래 분들은 EasyAIoT 프로젝트 배포 또는 업무 시나리오 구축을 완료하였으며, 그들의 탐색과 성과는 커뮤니티에 복제·참고 가능한 벤치마크를 제시했습니다. 이 뛰어난 실천자들에게 경의와 진심 어린 축하를 드립니다! 실천 순서대로 표시합니다:
